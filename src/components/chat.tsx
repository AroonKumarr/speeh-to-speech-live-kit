...
export function Chat() {
  ...
  return (
    // <></>
    <div className="flex flex-col h-full overflow-hidden p-2 lg:p-4 border-2 border-black">
      <ChatControls
        ...
        <div className="w-full h-full flex flex-col">
          ...
          <div className="grow h-full flex items-center justify-center">
            <div className="w-full hidden lg:block">
              {isChatRunning && !isEditingInstructions && renderOrbVideo()}
            </div>
          </div>
        </div>
